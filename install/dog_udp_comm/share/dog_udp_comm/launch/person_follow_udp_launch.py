...
def generate_launch_description():
    ...
    args = [
        ...
        DeclareLaunchArgument("max_v", default_value="0.8"),
        DeclareLaunchArgument("max_w", default_value="5.0"),
    ...
    mpc_controller_node = Node(
        ...
        parameters=[
            ...
            {"tracking_only_linear_speed": 0.08},
            ...
            {"speed_profile_min_v": 0.10},
            {"speed_profile_max_v": ParameterValue(LaunchConfiguration("max_v"), value_type=float)},
            {"angle_priority_threshold": 0.30},
            {"min_heading_speed_scale": 0.20},
            {"max_accel": 1.20},
            {"max_w_accel": 20.0},
        ],
    )
