...
int main(int argc, char **argv)
{
	...
	node_lidar.lidar_general_info.port = node->declare_parameter<std::string>(
		"port", node_lidar.lidar_general_info.port);

	node_lidar.lidar_general_info.m_SerialBaudrate = node->declare_parameter<int>(
		"baudrate", node_lidar.lidar_general_info.m_SerialBaudrate);

	node_lidar.lidar_general_info.frame_id = node->declare_parameter<std::string>(
